...
export declare const useWaffle: <D extends Datum = Datum>({ width, height, data, hiddenIds, valueFormat, total, rows, columns, fillDirection, colors, emptyColor, emptyOpacity, borderColor, forwardLegendData, defs, fill, }: Pick<CommonProps<D>, "fillDirection" | "emptyColor" | "emptyOpacity" | "hiddenIds" | "valueFormat" | "colors" | "borderColor"> & Pick<WaffleSvgProps<D>, "defs" | "fill"> & DataProps<D> & {
    width: number;
    height: number;
    ...
    getBorderColor: import("@nivo/colors").InheritedColorConfigCustomFunction<ComputedDatum<D> | {
        color: string;
    }> | ((d: ComputedDatum<D> | {
        color: string;
    }) => any);
