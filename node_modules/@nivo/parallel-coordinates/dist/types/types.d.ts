...
export type DatumGroupKeys<Datum extends BaseDatum> = keyof Pick<Datum, Exclude<FilterKeys<Datum, string>, 'id'>>;
...
export type IfGrouped<Datum extends BaseDatum, GroupBy extends DatumGroupKeys<Datum> | undefined, GroupedType, NonGroupedType> = GroupBy extends DatumGroupKeys<Datum> ? GroupedType : NonGroupedType;
...
export interface TooltipProps<Datum extends BaseDatum, GroupBy extends DatumGroupKeys<Datum> | undefined> {
    datum: IfGrouped<Datum, GroupBy, ComputedGroupDatum<Datum>, ComputedDatum<Datum>>;
    variables: readonly Variable<Datum>[];
}
export type TooltipComponent<Datum extends BaseDatum, GroupBy extends DatumGroupKeys<Datum> | undefined> = FunctionComponent<TooltipProps<Datum, GroupBy>>;
...
export interface CommonProps<Datum extends BaseDatum, GroupBy extends DatumGroupKeys<Datum> | undefined = undefined> extends MotionProps {
    groupBy: GroupBy;
    ...
    legends: LegendProps[];
    forwardLegendData: (data: IfGrouped<Datum, GroupBy, GroupLegend[], DatumLegend<Datum>[]>) => void;
    role: string;
...
export type ParallelCoordinatesCustomLayer<Datum extends BaseDatum> = FunctionComponent<CustomLayerProps<Datum>>;
type ParallelCoordinatesLayer<Datum extends BaseDatum> = LayerId | ParallelCoordinatesCustomLayer<Datum>;
export type ParallelCoordinatesProps<Datum extends BaseDatum, GroupBy extends DatumGroupKeys<Datum> | undefined> = DataProps<Datum> & Dimensions & Partial<CommonProps<Datum, GroupBy>> & {
    layers?: ParallelCoordinatesLayer<Datum>[];
    testIdPrefix?: string;
};
export type ParallelCoordinatesCanvasCustomLayer<Datum extends BaseDatum> = (ctx: CanvasRenderingContext2D, props: CustomLayerProps<Datum>) => void;
type ParallelCoordinatesCanvasLayer<Datum extends BaseDatum> = LayerId | ParallelCoordinatesCanvasCustomLayer<Datum>;
export type ParallelCoordinatesCanvasProps<Datum extends BaseDatum, GroupBy extends DatumGroupKeys<Datum> | undefined> = DataProps<Datum> & Dimensions & Partial<CommonProps<Datum, GroupBy>> & {
